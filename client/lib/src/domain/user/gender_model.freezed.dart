...
/// @nodoc
@JsonSerializable()
class _$_GenderModel extends _GenderModel {
  const _$_GenderModel({required this.id, required this.name}) : super._();
...
abstract class _GenderModel extends GenderModel {
  const factory _GenderModel(
      {required final int id, required final String name}) = _$_GenderModel;
